      ...
      <div className="container">
        <div className="row">
            <div className="col-md-6">
                <img src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_698,h_465/v1603308507/assets/f6/0c9607-ae68-43d5-9e88-79f3011d88ee/original/Sustainability.jpg" alt="" />
            </div>
            <div className="col-md-6">
                <p>Sustainability</p>
        ...
        <div className="row">
            <div className="col-md-6">
                <img src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_698,h_465/v1554854756/assets/74/0853d5-80e4-414a-91d7-6fd0b15a136d/original/UberIM_20250-medium-%282%29.jpg" alt="" />
            </div>
            <div className="col-md-6">
                <p>Rides and beyond</p>
        ...
        <div className="row">
            ...
            <div className="col-md-6">
                <img src="https://www.uber-assets.com/image/upload/q_auto:eco,c_fill,w_698,h_465/v1555433729/assets/13/b383de-93a1-4327-8812-91de86e3edd9/original/_background-01.svg" alt="" />
            </div>
        </div>
      </div>
    </div>
